...
import (
	...
	//corev1 "github.com/abhijitherekar/kubebuilder/pkg/apis/core/v1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	// Uncomment watch a Deployment created by Pod - change this for objects you create
...
// +kubebuilder:rbac:groups=core.k8s.io,resources=pods,verbs=get;list;watch;create;update;patch;delete
func (r *ReconcilePod) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	// Fetch the Pod instance
	instance := &corev1.Pod{}
	log.Println("Got a request", request)
